...
class Iface(object):
  def parseHtml(self, htmlContent, cvFrom):
    """
    Parameters:
     - htmlContent
     - cvFrom
...
class Client(Iface):
  ...
  def parseHtml(self, htmlContent, cvFrom):
    ...
    Parameters:
     ...
     - cvFrom
    """
    self.send_parseHtml(htmlContent, cvFrom)
    return self.recv_parseHtml()

  def send_parseHtml(self, htmlContent, cvFrom):
...
class Processor(Iface, TProcessor):
  ...
  def process_parseHtml(self, seqid, iprot, oprot):
    ...
    result = parseHtml_result()
    try:
      result.success = self._handler.parseHtml(args.htmlContent, args.cvFrom)
...
class parseHtml_args(object):
  ...
  def __init__(self, htmlContent=None, cvFrom=None,):
